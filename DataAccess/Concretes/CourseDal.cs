...
namespace DataAccess.Concretes
{
    public class CourseDal : ICourseDal
    {
        ...
        public CourseDal()
        {
            ...
            { 
                new Course {Id=1, Name="C#,",Description="C# Kursu",InstructorId=1,CategoryId=1},
                new Course {Id=2, Name="JAVA,",Description="JAVA Kursu",InstructorId=3,CategoryId=1 } ,
                new Course {Id=3, Name="React,",Description="React Kursu",InstructorId=2,CategoryId=2 } 
            };
